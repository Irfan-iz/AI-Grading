...
# 1. Move the import up here
from integrity_module import grade_submission, get_chatbot_response

# --- PAGE SETUP ---
st.set_page_config(page_title="NLP Auto-Grader", layout="centered")

# --- CHATBOT SIDEBAR (Moved to Top) ---
# By placing this first, it ensures the Chatbot is always at the top of the sidebar
with st.sidebar:
    st.header("💬 Chatbot")
...
if submitted:
    if not answer or not rubric:
        ...
        if result and 'grading_result' in result:
            ...
            col3.metric("Rubric Match", f"{round(similarity * 100, 1)}%")
